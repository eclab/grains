...
/// pattern was originally derived from Bjorklund's Algorithm, but in fact
/// it is actually a trivial result of Bressenham's Line Algorithm, which 
/// is simpler to compute (and we're using it below).
///
