...
Status: This is an **ALPHA** release.  The code compiles and the USB ROUTER mode works, as well as the DELEGATO mode.  No other modes have even been tested, and likely nothing else works right now.  The Java program works reasonably well.  I'm providing it here early in case anyone wanted to bang on it.
