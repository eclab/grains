...
///
/// POT 2           Choice of Partials [Set the switch to MAN]
///
...
#define CV_POT_IN1    A2    // Note in, Pitch Scaling   // Partials Selection
#define CV_POT_IN2    A1    // Partials Selection               // Pitch Tune
...
void updateControl()                          
    ...
    uint8_t d = (mozziAnalogRead(CV_POT_IN2) * 24) >> 10;
    if (d != draw)
        {
...
int updateAudio()                             
    ...
    return MonoOutput::from16Bit(val >> gainDivide);              // seems to get low enough?
    }
