...
#define ISR_RATIO (25000/ (1000000 / 8000) ) // gives 200 for SAMPLE_RATE 8000 -> 40 Hz or 25 ms Sample update frequency
...
uint16_t SAMPLE_RATE = buildSampleRate(); //map(analogRead(A1), 0, 1023, 4000, 16000);
