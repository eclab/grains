...
public:
// SEAN: If secondPin is 255, then it is unused
  NeoSWSerial(uint8_t receivePin, uint8_t transmitPin, uint8_t secondTransmitPin)
    {
      rxPin = receivePin;
      txPin = transmitPin;
      txPin2 = secondTransmitPin;
      _isr  = (isr_t) NULL;
    }
  ...
  void changeTxPin(uint8_t transmitPin) { txPin = transmitPin; } 

private:
           uint8_t  rxPin, txPin, txPin2;
